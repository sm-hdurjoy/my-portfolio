...
const Contact = () => {
  return (
    ...
    >
      <form
        method="POST"
        action="https://getform.io/f/b3e0ec50-137a-445e-83ba-42b57e4e9074"
      ...
      >
        <div className="pb-3">
          ...
          <p className="text-gray-300 py-4">
            ...
            hazzazdurjoy.drmc2013@gmail.com
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="relative h-10 w-full min-w-[200px]">
            <input
              className=" p-2 peer h-full w-full rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 text-gray-300"
              type="text"
              placeholder=""
              name="name"
              required
        ...
        <button className="text-white border-2 hover:bg-pink-600 hover:border-pink-700 px-4 py-3 my-8 mx-auto flex items-center">
          Let's Collaborate
        </button>
      </form>
    </div>
